...
class Database
{
    ...
    {
        try {
           //create a statement variable i.e. $sth that will contain the query data from the database if it is retrieved successfully
            ...
            //an Exception will be thrown if an error occurs at any point during the execution of the function
