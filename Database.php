...
class Database
{
    // public property to create a connection to the custom-built database for the app i.e. workopia database
    public $conn;

    /**
     * Constructor to connect to my database 
     * 
     * @param array $config
     * @return void
     */
    public function __construct($config)
    {
        ...
        try {
            //Create a new PDO instance to interact with the database i.e. the workopia database
    ...
    public function query($query, $params = [])
    {
        try {
           //create a statement variable i.e. $sth that will contain the query data if it is retrieved successfully
            ...
            //an Exception will be thrown if an error occurs at any point
