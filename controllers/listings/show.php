...
//get the unique id from the url by using the $_GET superglobal that is available in the entire application
$id = $_GET['id'] ?? '';
...
//load the view using the custom loadView method
