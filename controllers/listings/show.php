...
//the code below adds database protection to prevent unexpected sql injections into the custom database eg. accidentally deleting a table or adding incorrect information
$params = [
    'id' => $id
];
