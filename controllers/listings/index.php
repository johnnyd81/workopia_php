...
//the $listings variable contains the retrieved job listings from the database but limits them to 6 listings each time
$listings = $db->query('SELECT * FROM listings LIMIT 6')->fetchAll();

//the method below displays the retrieved job listings into the view (i.e. the user's webpage view)
