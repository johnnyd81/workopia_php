...
//conditional to check if a path exists
    if (file_exists($viewPath)) {
        ...
        //print an error message for the user if a specific view isn't available
...
{
    echo '<pre>'; // make the output data readable using the '<pre>' tag
    var_dump($value);
    echo '</pre>';
}

/* 
Inspect a value(s) and die i.e. stop the current script 
...
/**
 * format the salary amount to make it simpler to read at a glance
 * 
 * @param string $salary
