...
/*  
Get the base "path" for a specific file i.e. exact path to the specific file
@param string $path
@return string
*/
...
//conditional to check if a path exists
    if (file_exists($viewPath)) {
        ...
        //print a message for the user if a specific view cannot be found
...
function loadPartial($name)
{
    ...
    //check if the file is available or exists and then require it into the specific file i.e. load the specific webpage
...
{
    echo '<pre>'; // make the output data more readable using the '<pre>' tag
    var_dump($value);
    echo '</pre>';
}

/* 
Inspect a value(s) and die i.e. kill the current script 
...
/**
 * format the salary amount to be easier to read
 * 
 * @param string $salary
