...
/*  
Get the base path for a specific file i.e. path to the specific file
@param string $path
@return string
*/
...
function loadPartial($name)
{
    ...
    //check if the file is available or exists and then require it into the file where it is needed
