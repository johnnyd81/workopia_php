...
//conditional to check if a path exists
    if (file_exists($viewPath)) {
        ...
        //print a message for the user if a specific view isn't available
...
function loadPartial($name)
{
    ...
    //check if the file is available or if it exists and then require it into the file
...
/**
 * format the salary amount to make it easier to read at a glance
 * 
 * @param string $salary
